...
export interface TestSCRInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TestSCR extends BaseContract {
  connect(runner?: ContractRunner | null): TestSCR;
  waitForDeployment(): Promise<this>;

  interface: TestSCRInterface;
